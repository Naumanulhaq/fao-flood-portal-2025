# Geospatial Flood Impact Assessment Portal | Pakistan 2025
...
- **Crop Analysis**: Crop type mapping was performed leveraging advanced **satellite embeddings**, allowing for precise quantification of rice, cotton, sugarcane, and maize losses.
- **Flood Detection**: Peak inundation windows were analyzed using Sentinel-1 multi-temporal imagery (10 m resolution).
- **Human Impact**: Population exposure was estimated using WorldPop (2020) population grids.

## 📊 Key Indicators Analysed:
- **National Flood Extent**: Real-time monitoring of inundated areas across three provinces.
- **Sectoral Impact**: Detailed breakdown of losses for major Kharif crops.
- **Recovery Monitoring**: Comparative analysis between peak flooding and October 2025 recession.

## 📄 Official Resources
- **Full Technical Report**: [Download PDF Version](./Geospatial%20flood%20impact%20assessment%20in%20Pakistan%202025.pdf)
- **FAO Open Knowledge Repository**: [Access Publication](https://openknowledge.fao.org/items/a3d91bad-bbcb-42a1-85f1-0b9f6457d858)
